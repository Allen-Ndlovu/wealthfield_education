...
$students = $select_users->fetchAll(PDO::FETCH_ASSOC);
         ...
         <tbody>
            <?php foreach($students as $student): ?>
               <tr>
                  ...
                  <td>
                     <a href="uploaded_files/<?= htmlspecialchars($student['matric_certificate']); ?>" target="_blank">View Matric Certificate</a>
                  </td>
                  <td>
                     <a href="uploaded_files/<?= htmlspecialchars($student['bank_statement']); ?>" target="_blank">View Bank Statement</a>
                  </td>
                  <td>
